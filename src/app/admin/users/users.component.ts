...
export class UsersComponent extends AppComponentBase implements AfterViewInit {
    ...
    ngAfterViewInit(): void {
        ...
        console.log(' User.Component : 67 : '+this.permission.isGranted('Pages.Administration.Users.Create'));
        console.log('isGrantedAny : '  +this.isGrantedAny("Pages.Administration.Users.Edit","Pages.Administration.Users.Delete","Pages.Administration.Users.Create"));
    }
